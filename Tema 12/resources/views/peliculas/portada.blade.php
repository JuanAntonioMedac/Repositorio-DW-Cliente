    ...
    <body class="bg-ligth">
            ...
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <a href="" class="btn btn-outline-light btn-sm">
                        <i class="bi bi-gear"></i>Peliculas
                    </a>
                </div>
            </div>
        </nav>
        <div class="container my-5">
            ...
            <div class="text-center py-5 d-none" id="cargandoPeliculas">
                <div class="spinner-border text-primary" rolwe="status" style="width: 3rem; height: 3rem;">
        ...
        <script>
            ...
            //funcion para cargar por categoria
            async function cargarPeliculasPorCategoria(){
                ...
                try{
                    ...
                    if(!response.ok){
                        throw new Error('Error al cargar las películas por categoría');
                    }
                    const peliculas=await response.json();
            ...
            //funcion para mostrar las peliculas en tarjetas
            function mostrarPeliculas(peliculas,titulo){
                ...
                if(peliculas.length===0){
                    ...
                    <div class="alert alert-info text-center" role="alert">
                        ...
                        <h4 class"mt-3">no hay peliculas de esta categoría</h4>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <button class="btn btn-secondary w-100" disabled>
                                            <i class="bi bi-x-cicle"></i> Sin enlace IMDB
                                        </button>
                                        `}
                                    </div>
                                </div>
