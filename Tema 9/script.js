document.addEventListener('DOMContentLoaded', function() {
    ...
    // Hacer funciones globales para que onfocus/onblur las encuentren
    window.mensajeAyuda = mensajeAyuda;
    window.ocultarAyuda = ocultarAyuda;
    window.eliminarCookie = eliminarCookie;
});